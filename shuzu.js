...
// //     b:2,
// // }
// // log(...[clownsEverywhere,clownsEverywhere,clownsEverywhere])

// // log([...document.querySelectorAll('div')])
// // [<div>, <div>, <div>]
// // 该运算符主要用于函数调用。
...
// Array(3) // [, , ,]
// Array(3, 11, 8) // [3, 11, 8]
// // 上面代码中，Array方法没有参/数、一个参数、三个参数时，返回结果都不一样。只有当参数个数不少于 2 个时，Array()才会返回由参数组成的新数组。参数个数只有一个时，实际上是指定数组的长度。
...
// new Array(3).fill(7)
// // [7, 7, 7]
// // 上面代码表明，fill方法用于空数组的初始化非常方/便。数组中已有的元素，会被全部抹去。
...
// // 该方法的第二个参数表示搜索的起始位置，默认为0。如果/第二个参数为负数，则表示倒数的位置，如果这时它大于数组长度（比如第二个参数为-4，但数组长度为3），则会重置为从0开始。
